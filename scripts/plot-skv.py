...
plt.rc('font', size = 20)
plt.scatter(normal['elongation'], normal['sphericity'], s = 30, marker = 'o')
plt.scatter(thin['elongation'], thin['sphericity'], s = 30, marker = 's')
plt.scatter(mnist['elongation'], mnist['sphericity'], s = 30, marker = '*')
plt.scatter(mostly['elongation'], mostly['sphericity'], s = 30, marker = 'P')
